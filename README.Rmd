...
fPlotSonar = function (
   ...
   if ( is.null(nBlockLength1) ) {
      nBlockLength1 = nLocation1Size
   }
   
   if ( is.null(nBlockLength2) ) {
      nBlockLength2 = nLocation2Size
   }
   ...
   if ( nLocation1Size == nBlockLength1 ) {
      ...
      p1 = p1 + 
         geom_polygon(
            ...
            aes(
               x = x + ( nLocation1Size * nZoomFactor / 2 ),
               y = y + ( nLocation2Size * nZoomFactor / 2)
           ),
           color = '#222222',
           alpha = 0
         ) +
