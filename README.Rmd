...
cStatsbombLogoFilePath = '/home/ask/Documents/open-data/stats-bomb-logo.png'
...
knitr::include_graphics("./69334.217/plotOverallSonar.png")
knitr::include_graphics("./69334.217/plotPitchBreakupSonar.png")
knitr::include_graphics("./69334.217/plotPlayerBreakupSonar.png")
...
The position coordinates for the formations for a 4-3-3 and a 3-5-1-1 are 
available in the code but you will need to add these for your positions. 
ctrl + F for 3511 and add your formation details there.
...
split, depending on the formation the dimensions may change a little bit. I 
don't know of a good way to control this.

The fPlotSonar function has been tried with only these three configurations.
Any experiments may yield bugs in the logic. Please report them on 
https://github.com/thecomeonman/PassingSonarAlternative.
